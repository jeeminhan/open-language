...
export function buildLevelTestPrompt(): string {
  return [
    ...
    `   "Thanks — that was great. I have a sense of where you are."`,
    `   Do NOT announce a level. Do NOT say "you're B1". The app shows the level on the recap screen.`,
    `   Do NOT tell the learner to tap or end the call — the app ends it automatically.`,
    ``,
    `   END SIGNAL (CRITICAL — silent control token)`,
    `   IMMEDIATELY after your closing sentence, append the literal text [[LEVELTEST_DONE]] as the very last characters of your response.`,
    `   This is a SILENT control token consumed by the application.`,
    `   - DO NOT speak, pronounce, or vocalize [[LEVELTEST_DONE]] out loud.`,
    `   - DO NOT translate, paraphrase, or describe it.`,
    `   - DO NOT mention brackets, the word "done", or "level test" in any form.`,
    `   - It must appear ONCE and ONLY ONCE, and ONLY at the very end of your final closing message.`,
    ``,
    `STYLE`,
